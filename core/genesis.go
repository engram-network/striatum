...
// DefaultEngramGenesisBlock returns the Engram network genesis block.
func DefaultEngramGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.EngramChainConfig,
		Nonce:      0x1234,
		ExtraData:  hexutil.MustDecode("0x"),
		GasLimit:   0x17d7840,
		Difficulty: big.NewInt(0x01),
		Timestamp:  1694445630,
		Alloc:      decodePrealloc(engramAllocData),
	}
}
