...
func init() {
	// Run the app if we've been exec'd as "striatum-test" in runStriatum.
	reexec.Register("striatum-test", func() {
...
// spawns striatum with the given command line args. If the args don't set --datadir, the
...
func runGeth(t *testing.T, args ...string) *testgeth {
	...
	// Boot "striatum". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("striatum-test", args...)
