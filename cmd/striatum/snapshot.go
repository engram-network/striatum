...
var (
	snapshotCommand = &cli.Command{
		...
		Subcommands: []*cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale engram state data based on the snapshot",
				ArgsUsage: "<root>",
				Action:    pruneState,
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'striatum dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'striatum dump', but uses the snapshots
