		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Engram presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
...
between Engram nodes by simply copying.
...
`,
			},
			{
				...
				Description: `
    striatum account update <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    striatum account import <keyfile>
