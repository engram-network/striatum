...
var (
	...
	EngramGenesisHash  = common.HexToHash("0x3c269e50e41e624f53def3d13249eef59f2751222b1b4d8ded672cbacee4299a")
...
var (
	...
	// EngramChainConfig contains the chain parameters to run a node on the Engram test network.
	EngramChainConfig = &ChainConfig{
		...
		TerminalTotalDifficultyPassed: true,
		MergeNetsplitBlock:            nil,
		ShanghaiTime:                  newUint64(1694445690),
		CancunTime:                    newUint64(1702125690),
		Ethash:                        new(EthashConfig),
	}
...
var NetworkNames = map[string]string{
	...
	EngramChainConfig.ChainID.String(): "engram",
}
